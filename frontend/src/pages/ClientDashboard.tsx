...
import { FolderKanban, PlayCircle, Clock, CheckCircle2, ChevronRight, HelpCircle, Loader2, Search } from 'lucide-react';
import { Progress, Tag, Alert, Input, Select } from 'antd';
