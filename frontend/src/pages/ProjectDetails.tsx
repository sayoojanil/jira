                  ...
                  <div className="space-y-3 max-h-[200px] overflow-y-auto pr-1">
                    {project.assignedClients && project.assignedClients.length > 0 ? (
                      project.assignedClients.map((client: any) => (
                        ...
                        >
                          <Avatar
                            src={client.profilePic ? `http://localhost:5000${client.profilePic}` : undefined}
                      ...
                      >
                        <Avatar
                          src={project.client.profilePic ? `http://localhost:5000${project.client.profilePic}` : undefined}
                          className="h-8 w-8 md:h-10 md:w-10"
                        >
                  ...
                  <div className="space-y-3 max-h-[300px] overflow-y-auto pr-1">
                    {project.assignedTeam && project.assignedTeam.length > 0 ? (
                      project.assignedTeam.map((member: any) => (
                        ...
                        >
                          <Avatar
                            src={member.profilePic ? `http://localhost:5000${member.profilePic}` : undefined}
                            className="h-8 w-8 md:h-10 md:w-10"
                          >
                    ...
                    files.map((file) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          <a
                            href={file.url.startsWith('/uploads/') ? `http://localhost:5000${file.url}` : file.url}
                            download
                            target="_blank"
